                                        ...
                                        <div>
                                            <div className="relative flex items-center gap-[-1.5]">
                                                ...
                                                {cart.length > 0 && (
                                                    <Badge
                                                        variant="destructive"
                                                        className="translate-x-1 -translate-y-1/2 rounded-2xl"
                                                    >
                                                        {cart.length}
                                                    </Badge>
                                                )} */}
                                            ...
                                            <Dropdown>
                                                <Dropdown.Trigger>
                                                    <span className="inline-flex rounded-md">
                                                        <button
                                                            type="button"
                                                            className="inline-flex cursor-pointer items-center gap-2 rounded-md border border-transparent bg-white px-3 py-2 text-sm leading-4 font-medium text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none dark:bg-gray-800 dark:text-gray-400 dark:hover:text-gray-300"
                                                        >
                                                            <CircleUserRound
                                                                size={24}
                                                            />
