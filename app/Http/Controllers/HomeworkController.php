...
class HomeworkController extends Controller
{
    ...
    {
        $query = Homeworks::select(['homework_id', 'homework_date', 'class_name', 'subject_name', 'first_name', 'last_name'])
    ...
    public function edit($id)
    {
        ...
        $branches = $this->branches;
        $classes = BranchClass::getCustomClassesByBranchIds($user);
        $homework = Homeworks::select(['homework_id', 'homework_description', 'homework_date', 'class_id', 'subject_id'])
